...
export default function AboutUs() {
  ...
  return (
    <div className={`min-h-screen font-space-grotesk transition-colors duration-300 ${darkMode ? 'bg-black text-white' : 'bg-gray-50 text-gray-900'} ${spaceGrotesk.variable}`}>
      {/* Hero Section */}




      <section className="flex  w-full text-black px-20 py-20 max-md:flex-col">
      ...
      <article className="relative flex flex-col py-10 w-full   bg-lime-400 border border-white border-solid rounded-[32px] overflow-visible ">
        ...
        <div className="flex flex-wrap gap-5 justify-center mt-8 w-full text-2xl text-center">
...
<section className='px-20'>
      ...
      <WavyBackground
      height={600}                    // tweak as needed
      className=" py-16 lg:px-0"  // gives you top/bottom padding
    >
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <motion.h2
            ...
            className="text-3xl sm:text-4xl font-bold mb-6 text-green-600 dark:text-lime-400 uppercase"
          >
            Why Choose 5 Sports?
          </motion.h2>
          ...
          >
            {features.map((item, idx) => (
              ...
              >
                ...
                <div>
                  <strong className="text-lime-400 dark:text-lime-400 text-lg sm:text-xl">
                    {item.title}
                  </strong>
          ...
          <motion.p
            variants={itemVariants}
            className="mt-8 text-lg text-gray-700 text-center dark:text-gray-50"
          >
      ...
      <section className="flex  w-full text-black  max-md:flex-col mb-10 mt-20">
      {/* Main Article with notches */}
  ...
  <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4'>
    ...
    >
      ...
      <section className="flex  w-full text-black px-20 max-md:flex-col mb-10">
      {/* Main Article with notches */}
      <article className="relative flex flex-col py-10 w-full   bg-green-500 border border-white border-solid rounded-[32px] overflow-visible ">
        {/* Left notch */}
        <div
          className="absolute -left-8 top-1/2 w-[60px] h-[60px] bg-black rounded-full 
                     transform -translate-y-1/2"
          ...
          {teamMembers.map((m, i) => (
            <Card
              ...
              description={`
                ...
                🌐 ${m.website}
              `}
              iconType="sport" // unused in current SportIcon, but you can switch icons based on this
            />
          ))}
        </div>
      </section>
